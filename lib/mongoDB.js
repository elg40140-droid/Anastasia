...
let schema=this._schema=new Schema({data:{type:Object,required:true,default:{}}})
...
let schema=new Schema({data:Array})
let doc
try{doc=_model(key,schema)}catch(e){console.error(e);doc=_model(key)}
